...
% In this paper, we show that the same concept is applicable to Symbolic Regression, where the search space, consisting of mathematical expressions encoded in tree form, is explored through the repeated application of the so-called recombination operators: \emph{crossover} and \emph{mutation}. These operators combine or modify parts of existing expressions randomly, having a high probability of generating previously-seen expressions, particularly in the later stages of the search when most of the initial genetic diversity is lost.
