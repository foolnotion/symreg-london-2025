...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Average fitness and average length, with/without caching}\label{fig:avg-fitness-length}
\end{figure}
